      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <header className="flex items-center justify-between p-4 md:p-6 md:px-8 border-b border-white/5 sticky top-0 z-50 backdrop-blur-md bg-[#05050a]/80">
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg md:text-xl tracking-tight uppercase">GHOST<span className="text-[#ee2a7b]">DL</span></span>
          </Link>
        ...
        <footer className="mt-auto pt-16 border-t border-white/5 flex flex-col bg-transparent text-slate-400 pb-12 relative z-10">
          <div className="max-w-4xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 w-full">
            <div className="col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-bold tracking-tight text-white">GHOST<span className="text-[#ee2a7b]">DL</span></span>
              </div>
              <p className="text-sm leading-relaxed mb-6">
                Universal media downloader for YouTube, Instagram, TikTok, Facebook, Twitter, and Pinterest. Fast, secure, and 100% free.
              </p>
            </div>
            
            <div>
              <h4 className="text-white font-bold tracking-widest text-xs uppercase mb-4">TOOLS</h4>
              <ul className="space-y-3 text-sm">
                <li><Link to="/" className="hover:text-white transition">Video Downloader</Link></li>
                <li><Link to="/" className="hover:text-white transition">Audio Extractor</Link></li>
              </ul>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 w-full mt-16 pt-8 border-t border-white/5 text-xs text-center md:text-left flex flex-col md:flex-row justify-between items-center gap-4">
            <p>© 2024 Ghost Downloader. All rights reserved.</p>
